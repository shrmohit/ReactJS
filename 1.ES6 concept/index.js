...
// map-> create new array and not modify oringal array
...
//find -> is used to check condition wirh array object
// return its first true condition and  not check orther condition
...
// filter -> return all true condition if check it
...
//some -> is used to if tests whether at least one element in array passes the test it return true ,not false
...
// every ->is used to check all element of array passes condition if they return true
...
// includes -> return true if passes value is inside the array
const fruitsArray = ["apple", "banana", "orange"];

console.log(fruitsArray.includes("sangam"), fruitsArray.indexOf("sangam")); // o/p -> -1(false)

// if it true means condition satisfied
